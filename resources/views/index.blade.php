                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-8 col-lg-6">
                            <div class="hero-content">
                                <h6 class="hero-sub-title wow animate__animated animate__fadeInUp" data-wow-duration="1s"
                                    data-wow-delay=".25s">Start To New Journey</h6>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="hero-img"
                                style="background-image: url({{ asset('storage/img/hero/hero.jpg') }})"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="course-area bg py-120">
            <div class="container">
                <div class="row">
                    <div class="mx-auto col-lg-6">
                        <div class="text-center site-heading">
                            <h2 class="mb-2 site-title">{{ __('till.courses-h2-1') }}  <span> {{ __('till.courses-h2-2') }}</span></h2>
                ...
                <div class="text-center">
                    <a href="#" class="mt-5 theme-btn"><span class="fad fa-sync-alt"></span> {{ __('till.course-cat-btn') }}</a>
                </div>
            </div>
        </div>
        ...
        <div class="instructor-area py-120">
            <div class="container">
                <div class="row">
                    <div class="mx-auto col-lg-6">
                        <div class="text-center site-heading">
                            <h2 class="site-title">{{ __('till.instructor-h2-1') }} <span>{{ __('till.instructor-h2-2') }}</span></h2>
                            <p>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="instructor-item">
                            <div class="instructor-img">
                                <a href="#"><img src="{{ asset('storage/img/instructor/01.jpg') }}" alt="img"></a>
                            </div>
                            <div class="instructor-content">
                                ...
                                <div class="instructor-rate">
                                    ...
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                                    <span>(22 {{ __('till.istrucgtor-sharx') }})</span>
                                </div>
                                <span class="instructor-enroll"><i class="far fa-user-friends"></i> 7.9{{ __('till.instructor-count') }}</span>
