    ...
    <div class="cards-area ptb-30">
        <div class="container">
            <div class="section-title left-title">
                <h2 style="text-align: center; margin: 10px 0;">{{$conferensShow->title}}</h2>
            </div>
            <div class="single-card-item p-0 bg-transparent">
                <img src="{{asset('upload/conference/' .$conferensShow->user_image.'_thumbnail_267.png')}}" alt="Images">
                ...
                <p>{{strip_tags($conferensShow->text)}}</p>
            </div>
        </div>
    </div>
