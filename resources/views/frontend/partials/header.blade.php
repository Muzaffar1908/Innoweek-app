                  ...
                  @switch($locale)
                      ...
                      @case('')
                        <li class="menu-item menu-item-has-children wow fadeInUp animated" data-wow-delay="0.9s">
                          <a href="locale/uz" class="d-flex align-items-center justify-content-center">
                      ...
                      @case('en')
                        <li class="menu-item menu-item-has-children wow fadeInUp animated" data-wow-delay="0.9s">
                          <a href="locale/en" class="d-flex align-items-center justify-content-center">
                      ...
                      @case('ru')
                        <li class="menu-item menu-item-has-children wow fadeInUp animated" data-wow-delay="0.9s">
                          <a href="locale/ru" class="d-flex align-items-center justify-content-center">
