          ...
          <div class="inner-wrap">
            <div class="d-flex align-items-center justify-content-between">
              <div class="site-branding">
                <a href="#home" class="logo logo-light wow fadeInUp animated" data-wow-delay="0.20s"><img src="{{asset('frontend/image/min.webp')}}" alt="Logo" width="50"></a>
                <a href="#home" class="logo logo-light wow fadeInUp animated" data-wow-delay="0.40s"><img src="{{asset('frontend/image/logo.webp')}}" alt="Logo" width="120"></a>
                <a href="#home" class="logo logo-dark"><img src="{{asset('frontend/image/min.webp')}}" alt="Logo" width="50"></a>
                <a href="#home" class="logo logo-dark"><img src="{{asset('frontend/image/logo.webp')}}" alt="Logo" width="120"></a>
              </div>
              <nav id="dropdown" class="template-main-menu menu-text-light">
                <ul class="menu">
                  ...
                  <li class="menu-item menu-item-has-children wow fadeInUp animated" data-wow-delay="0.8s">
                    <a href="#">INNOWEEK 2022</a>
                    <ul class="sub-menu menu-w">
                      <li class="menu-item"><a href="{{asset('frontend/pdf/inno.pdf')}}" target="_blank">Innoweek 2022 Invitation</a>
                      </li>
                      <li class="menu-item"><a href="{{asset('frontend/pdf/Innoen.pdf')}}" target="_blank">Innoweek 2022 Presentation</a>
                      </li>
                    </ul>
                  </li>
                </ul>
                ...
                <ul class="menu">
                  <li class="menu-item menu-item-has-children wow fadeInUp animated" data-wow-delay="0.9s">
                    <a href="#" class="d-flex align-items-center justify-content-center">
                      <img class="mx-2" width="30" src="{{asset('frontend/image/en.png')}}" alt="">
                      <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="sub-menu menu-color">
                      <li class="menu-item text-center"><a href="#"><img class="mx-2" width="30" src="{{asset('frontend/image/ru.png')}}" alt=""></a>
                      </li>
                      <li class="menu-item text-center"><a href="#"><img class="mx-2" width="30" src="{{asset('frontend/image/uz.png')}}" alt=""></a>
                      </li>
                    </ul>
                  </li>
                </ul>
