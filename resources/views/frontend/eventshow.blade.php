        ...
        <div class="col-lg-8">
          <div class="event-single-box">
            ...
            <div class="content-box">
              ...
              <h2 class="title wow fadeInUp animated" data-wow-delay="0.4s" data-wow-duration="1s">{!! substr($events->{'title_'.App::getLocale()},0,90).'...' !!}</h2>
              <p class="description wow fadeInUp animated" data-wow-delay="0.5s" data-wow-duration="1s">
                {!! substr($events->{'description_'.App::getLocale()},0,90).'...' !!}
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 template-sidebar wow fadeInUp animated" data-wow-delay="0.3s" data-wow-duration="1s">
          <div class="widget widget-border">
            ...
            <div class="widget-recent-post">
              @foreach($eventsx as $item)
                <div class="single-post">
                  <div class="figure-box">
                    <a href="{{route('eventshowx', ['id' => $item])}}" class="link-item"><img width="150" src="{{asset('frontend/image/image.jpg')}}" alt="Post"></a>
                  </div>
                  <div class="content-box">
                    <h3 class="entry-title"><a href="{{route('eventshowx', ['id' => $item])}}"></a>{!! substr($item->{'title_'.App::getLocale()},0,90).'...' !!}</h3>
