            ...
            <div class="swiper-wrapper large">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="figure-box">
                        <a href="{{route('eventshowx', ['id'=>$item->id])}}"><img style="object-fit: cover;" src="{{asset('/upload/conference/'. $item->user_image .'-d.png')}}" alt="Event"></a>
                    </div>
        ...
        <div class="container">
            ...
            @foreach ($news as $item)
                ...
                <div class="blog-box-layout1">
                    ...
                    <a href="{{route('newsshowx',['id'=>$item->id])}}" class="link-wrap"><img width="728" height="480" src="{{asset('/upload/news/'. $item->user_image.'-d.png')}}" alt="blog" width="728" height="480"></a>
        ...
        <div class="container-fluid ps-0 pe-0">
            ...
            @foreach ($galleries as $item)
                ...
                <div class="gallery-box-layout3 has-animation">
                    <a href="{{asset('/upload/galeries/' . $item->image.'-d.png')}}" class="rt-mfp-gallery-item"><img src="{{asset('/upload/galeries/' . $item->image.'-d.png')}}" alt="Gallery" width="900" height="780"></a>
                </div>
                </div>
            @endforeach
            </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-4 wow fadeInLeft animated" data-wow-delay="0.5s" data-wow-duration="1s">
                    ...
                    <div class="address-box color-two">
                        ...
                        <li><a href="mailto:innoweekuz2021@gmail.com">{{$innoweeks->email}}</a></li>
                        </ul>
                    </div>
                    </div>
                </div>
                <div class="col-lg-4 wow fadeInLeft animated" data-wow-delay="0.3s" data-wow-duration="1s">
                    ...
                    <div class="address-box color-one">
                        ...
                        <h3 class="title">{{__('Venue Info')}}</h3>
                        <ul class="address-details">
                ...
                <div class="col-lg-4 wow fadeInLeft animated" data-wow-delay="0.7s" data-wow-duration="1s">
                    ...
                    <div class="address-box color-three">
                        ...
                        <h3 class="title">{{__('Contact No')}}</h3>
                        <ul class="address-details">
