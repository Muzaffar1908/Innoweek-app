        ...
        <div class="container">
            ...
            @foreach ($news as $item)
                ...
                <div class="blog-box-layout1">
                    ...
                    <a href="{{route('newsshowx',['id'=>$item->id])}}" class="link-wrap"><img src="{{asset('/upload/news/'. $item->user_image.'-d.png')}}" alt="blog" width="728" height="480"></a>
                    ...
                    <div class="content-box">
                    <h3 class="entry-title"><a>{{$item->title_uz}}</a></h3>
