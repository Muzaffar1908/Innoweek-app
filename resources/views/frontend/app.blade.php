        ...
        <div class="container">
            ...
            @foreach ($news as $item)
                ...
                <div class="blog-box-layout1">
                    ...
                    <a href="{{route('newsshowx',['id'=>$item->id])}}" class="link-wrap"><img width="728" height="480" src="{{asset('/upload/news/' . $item->user_image.'_big_728.png')}}" alt="blog" width="728" height="480"></a>
