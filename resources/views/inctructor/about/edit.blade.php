        ...
        <div class="container">
            <div class="col-md-5 mx-auto">
                <div class="login-form">
                    ...
                    <form method="POST" action="/teacher/about/update/{{$about->id}}">
                        @csrf
                        <div class="form-group">
                            <label for="text"><h5>About text</h5></label>
                            <input type="hidden" name="ins_id" value="{{$about->user_id}}">

                            <textarea name="text" class="form-control" required id="text" cols="30" rows="10" placeholder="Text" autofocus>{{$about->text}}</textarea>
                        </div>
