            ...
            <div class="offcanvas-content">
              <form class="box " action="{{route('code')}}">
                ...
                <div class="input-names">
                    <input class="name" name="first_name" type="text" placeholder="{{__('Firstname')}}" autocomplete="off" required>
                    <input class="surname" name="last_name" type="text" placeholder="{{__('Lastname')}}" autocomplete="off" required>
                </div>
