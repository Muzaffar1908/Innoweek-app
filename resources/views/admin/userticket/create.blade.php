     ...
     <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.userticket.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-3">
                        {{-- <label for="ticket_serial">Ticket serial</label> --}}
                        <input type="hidden" name="id"  class="form-control" id="id" placeholder="Ticket serial enter" value="{{old('id')}}" />
                    </div>
