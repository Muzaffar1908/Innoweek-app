            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.innoweek.update', $innoweek->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description_uz"  class="form-control" cols="10" rows="5">{{$innoweek->description_uz}}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="mytextarea">Description ru</label>
                        <textarea name="description_ru" class="form-control" cols="10" rows="5">{{$innoweek->description_ru}}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="mytextarea">Description en</label>
                        <textarea name="description_en" class="form-control" cols="10" rows="5">{{$innoweek->description_en}}</textarea>
                    </div>
