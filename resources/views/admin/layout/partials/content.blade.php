    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-sm-6">
            <div class="dlab-cource">
              ...
              <img
                src="images/vector/bookmarks.png"
                class="bookmarks"
                alt=""
              />
            </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">So'ngi Talabalar</h4>
            </div>
            <div class="card-body">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">So'ngi Kurslar</h4>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-responsive-md">
