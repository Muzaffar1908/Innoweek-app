...
@section('content')
    ...
    <main class="main">
        ...
        @endif
                        <form method="POST" action="/course/save" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class=" form-control" name="narx"   required type="number">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control"  name="eski_narx"  type="number">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control"  name="davomiylik"  required type="number">
                            </div>
                            <div class="form-group">
                                <label for="date2">
                                    <h5>Videolar umumiy uzunligi(soat)</Video></h5>
                                </label>
                                <input class="form-control"  name="lenght"  required type="number">
                            </div>
                            <div class="form-group">
                                <label for="date2">
                                    <h5>Course o'tilgan til</Video></h5>
                                </label>
                                <input class="form-control"  name="lang"  required type="text">
                            </div>
                            <div class="form-group">
                                <label for="date2">
                                    <h5>Images</Video></h5>
