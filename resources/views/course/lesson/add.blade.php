            ...
            <div class="container">
                <div class="col-md-5 mx-auto">
                    <div class="login-form">
                        ...
                        @endif
                        <form method="POST" action="/course/lesson/save" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" value="{{ $c_id }}" name="cource_id">
                            <input type="hidden" value="{{ $l_id }}" name="uroven">

                            <div class="form-group">
                                <label for="text">
                                    <h5>Name</h5>
                                </label>
                                <input type="text" class="form-control" required name="name" id="text"
                            ...
                            <div class="form-group">
                                <label for="text">
                                    ...
                                    <Select name="tip" required class="form-control">
                                        ...
                                        <option value="premmum">premmum</option>
                                    </Select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" required name="file" id="text"
                                    placeholder="File">
