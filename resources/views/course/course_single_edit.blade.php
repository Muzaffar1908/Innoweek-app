                                                            ...
                                                            if($tartib==1){
                                                                ...
                                                                <div class="accordion-body">
                                                                    @foreach ($v->video as $d)
                                                                        @if (($d->tip == 'free' or isset($buy)) and
...
@endif"
                                                                            ...
                                                                            <div class="course-curriculum-right">
                                                                                <span class="course-curriculum-lock">
                                                                                    ...
                                                                                    @if (Auth::user()->id == $cource->user->id)
                                                                                        <a
                                                                                            href="/course/lesson/edit/{{ $d->id }}"><i
                                                                                                style=" font-size:15px; color:rgb(2, 139, 57))"
                                                                                                class="far fa-edit"></i></a>
                                                                                        <a
                                                                                            href="/course/lesson/delete/{{ $d->id }}"><i
                                                                                                class="far fa-trash-alt "
                                                                                                style=" font-size:15px; color:red"></i></a>
                                                                                    @endif
                                                                    ...
                                                                    @if (Auth::user()->id == $cource->user->id)
                                                                        <a href="/course/lesson/add/{{ $cource->id }}/{{ $v->id }}"
                                                                            style="" class="btn btn-info">Add a new
                                                                            lesson</a>

                                                                        <a href="/course/les_lev/edit/{{ $v->id }}"
                                                                            class="btn btn-success"><i
                                                                                class="far fa-edit"></i> Edit a lesson
                                                                            lavel</a>
                                                                        <a href="/course/les_lev/delete/{{ $v->id }}"
                        ...
                        <div class="course-single-sidebar">
                            <div class="course-single-sidebar-wrapper">
                                ...
                                @if (Auth::user()->id == $user->id)
                                    ...
                                    <a href="/course-single/{{ $cource->id }}" class="theme-btn"
