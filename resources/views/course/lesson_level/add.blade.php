...
@section('content')
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb">
            ...
            <div class="container">
                ...
                <ul class="breadcrumb-menu">
                    ...
                    <li class="active">Lesson Level</li>
                </ul>
            </div>
        </div>
        ...
        @endif
                        <form method="POST" action="/course/les_lev/save">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="text" placeholder="New lesson name">
