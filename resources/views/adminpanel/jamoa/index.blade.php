                        ...
                        <div style="display:flex;flex-direction:row; justify-content:space-between; align-items:center;">
                            <div>
                                ...
                                <p class="card-description">
                                    Eduhub jamoasi azolari malumotlarini shu  yerda
                                    to'ldiriladi.
                                </p>
                            </div>
                            <div>
                                <a href="/admin/jamoa/add" class="btn btn-success btn-fw">Add</a>
                                ...
                                <tbody>
                                    @foreach ($nega as $eduhub)
                                        <tr>
                                            ...
                                            <td>
                                                <p>
                                                    <img src="{{asset('storage/jamoa/'.$eduhub->img)}}" alt=""
                                            ...
                                            <td>
                                                <p
                                                    ...
                                                    <a href="/admin/jamoa/edit/{{ $eduhub->id }}"
                                                    ...
                                                    <a href="/admin/jamoa/dell/{{ $eduhub->id }}"
