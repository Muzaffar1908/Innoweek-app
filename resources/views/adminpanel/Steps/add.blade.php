      ...
      <div class="col-12 grid-margin">
        ...
        <form  action="/admin/qadam/save" method="Post" enctype="multipart/form-data" class="forms-sample" style="margin:10px 0px;">
            ...
            <div class="form-group">
              ...
              <input type="link" name="link_youtube" class="form-control" id="exampleInputEmail3" placeholder="you-tube link">
            </div>
            <div class="form-group">
            ...
            <div class="form-group" style="margin:20px 0;">
              ...
              <input type="text" name="title1_uz" class="form-control" id="exampleInputCity1" placeholder="Title">
            </div>
            <div class="form-group" style="margin:20px 0;">
              <label for="exampleTextarea1" >Text uz</label>
              <textarea class="form-control" name="text1_uz"  id="exampleTextarea1" rows="4"></textarea>
            </div>
            <div class="form-group" style="margin:20px 0;">
