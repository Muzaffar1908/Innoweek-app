...
<div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        ...
        @endif
        <form  action="/admin/policy/save" method="Post" enctype="multipart/form-data" class="forms-sample" style="margin:10px 0px;">
            @csrf
            ...
            <a href="/admin/policy" class="btn btn-dark">Cancel</button>
          </form>
          </div>
        </div>
      </div>
