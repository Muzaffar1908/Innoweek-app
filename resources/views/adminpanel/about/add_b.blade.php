...
<div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        ...
        @endif
        <form  action="/admin/about_b/save" method="Post" enctype="multipart/form-data" class="forms-sample" style="margin:10px 0px;">
            @csrf
            <h6 >Havfsizlik qaydnomasiga yangi shartlar qo'shing.</h6>
            <div class="form-group mx-10">
                <label for="exampleInputName1">Icon</label>
                <input type="text" name="icon" class="form-control"  id="exampleInputName1" placeholder="Icon">
