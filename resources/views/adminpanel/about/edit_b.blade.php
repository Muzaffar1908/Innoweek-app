...
<div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        ...
        @endif
        <form  action="/admin/about_b/update/{{$nu->id}}" method="Post" enctype="multipart/form-data" class="forms-sample" style="margin:10px 0px;">
            @csrf
            <div class="form-group">
                <label for="exampleInputName1">Privacy-Policy icon</label>
                <input type="text" value="{{$nu->icon}}" name="icon" class="form-control"  id="exampleInputName1" placeholder="Icon">
              </div>
            <div class="form-group">
            ...
            <a href="/admin/about" class="btn btn-dark">Cancel</a>
          </form>
          </div>
        </div>
      </div>
