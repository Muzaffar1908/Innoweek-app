    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            <a class=" sidebar-brand brand-logo" href="/adminpanel" style="font-size:35px; text-decoration:none; letter-spacing:3px;  font-weight:bold;color:red;">
                Edu<span style="color:#00af92">Hub</span>
            </a>


               <a class="sidebar-brand brand-logo-mini" style="font-size:35px; text-decoration:none; font-weight:bold;color:red;" href="index.html">
                E<span style="color:#00af92">H</span>
                </a>
        </div>
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  ...
                  <img class="img-xs rounded-circle" src="{{asset('storage/user/'.Auth::user()->img)}}" alt="">
                  @if (Auth::user()->level==="gold")
              ...
              <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
                <a href="/admin/admin/{{ Auth::user()->id }}" class="dropdown-item preview-item">
                ...
                <div class="dropdown-divider"></div>
                @if (Auth::user()->level==="gold")
                <a href="/admin/admins/add" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1 text-small">Add New Administrator</p>
                    </div>
                  </a>
                @endif
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
              <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © EduHub.com 2022</span>
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Home:<a href="https://www.bootstrapdash.com/bootstrap-admin-template/" target="_blank">EduHub</a></span>
              </div>
            </footer>
            <!-- partial -->
          </div>
